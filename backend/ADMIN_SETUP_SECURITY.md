...
```bash
curl -X POST https://codeduplicator-4.preview.emergentagent.com/api/setup-admin
```

### Method 2: Browser Console
```javascript
fetch('https://codeduplicator-4.preview.emergentagent.com/api/setup-admin', {
  method: 'POST'
})
.then(r => r.json())
.then(console.log)
...
```
POST https://codeduplicator-4.preview.emergentagent.com/api/setup-admin
