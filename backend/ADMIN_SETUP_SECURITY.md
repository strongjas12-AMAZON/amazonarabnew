...
```bash
curl -X POST https://repo-twin-2.preview.emergentagent.com/api/setup-admin
```

### Method 2: Browser Console
```javascript
fetch('https://repo-twin-2.preview.emergentagent.com/api/setup-admin', {
  method: 'POST'
})
.then(r => r.json())
.then(console.log)
...
```
POST https://repo-twin-2.preview.emergentagent.com/api/setup-admin
