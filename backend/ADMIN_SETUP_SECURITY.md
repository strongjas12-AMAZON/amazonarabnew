...
```bash
curl -X POST https://supabase-auth-17.preview.emergentagent.com/api/setup-admin
```

### Method 2: Browser Console
```javascript
fetch('https://supabase-auth-17.preview.emergentagent.com/api/setup-admin', {
  method: 'POST'
})
.then(r => r.json())
.then(console.log)
...
```
POST https://supabase-auth-17.preview.emergentagent.com/api/setup-admin
