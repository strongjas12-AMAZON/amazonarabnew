...
```bash
curl -X POST https://git-copier-1.preview.emergentagent.com/api/setup-admin
```

### Method 2: Browser Console
```javascript
fetch('https://git-copier-1.preview.emergentagent.com/api/setup-admin', {
  method: 'POST'
})
.then(r => r.json())
.then(console.log)
...
```
POST https://git-copier-1.preview.emergentagent.com/api/setup-admin
