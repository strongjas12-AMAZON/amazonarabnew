...
```bash
curl -X POST https://code-mirror-48.preview.emergentagent.com/api/setup-admin
```

### Method 2: Browser Console
```javascript
fetch('https://code-mirror-48.preview.emergentagent.com/api/setup-admin', {
  method: 'POST'
})
.then(r => r.json())
.then(console.log)
...
```
POST https://code-mirror-48.preview.emergentagent.com/api/setup-admin
