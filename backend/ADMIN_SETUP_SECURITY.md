...
```bash
curl -X POST https://repo-duplicator-11.preview.emergentagent.com/api/setup-admin
```

### Method 2: Browser Console
```javascript
fetch('https://repo-duplicator-11.preview.emergentagent.com/api/setup-admin', {
  method: 'POST'
})
.then(r => r.json())
.then(console.log)
...
```
POST https://repo-duplicator-11.preview.emergentagent.com/api/setup-admin
