...
```bash
curl -X POST https://clone-master-88.preview.emergentagent.com/api/setup-admin
```

### Method 2: Browser Console
```javascript
fetch('https://clone-master-88.preview.emergentagent.com/api/setup-admin', {
  method: 'POST'
})
.then(r => r.json())
.then(console.log)
...
```
POST https://clone-master-88.preview.emergentagent.com/api/setup-admin
