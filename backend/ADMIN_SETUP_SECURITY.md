...
```bash
curl -X POST https://catalog-refactor.preview.emergentagent.com/api/setup-admin
```

### Method 2: Browser Console
```javascript
fetch('https://catalog-refactor.preview.emergentagent.com/api/setup-admin', {
  method: 'POST'
})
.then(r => r.json())
.then(console.log)
...
```
POST https://catalog-refactor.preview.emergentagent.com/api/setup-admin
