        ...
        <div className="luxury-card mb-8">
          ...
          {!earnings ? (
            ...
            <div className="space-y-8">
              ...
              {/* Wallet Balance Withdrawal Section */}
              <div className="border-t border-[rgba(212,175,55,0.1)] pt-8 mt-8">
                <h3 className="text-xl font-semibold text-white mb-4">Wallet Balance Withdrawal</h3>
                ...
                {walletBalance && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="p-4 bg-[rgba(30,30,30,0.8)] rounded-lg border border-[rgba(212,175,55,0.2)]">
                      <p className="text-gray-400 text-sm mb-1">Total Recharged</p>
                      <p className="text-2xl font-bold text-blue-400">${walletBalance.totalRecharged.toFixed(2)}</p>
                    </div>
                  </div>
                )}
                ...
                <div className="mb-6 p-4 bg-green-500/10 border border-green-500/30 rounded-lg">
                  <p className="text-sm text-green-300 flex items-start gap-2">
                    ...
                    <span>
                      ...
                      This is separate from your total earnings payout above.
                    </span>
                  </p>
                </div>
                ...
                <form
                  ...
                  onSubmit={async (e) => {
                    ...
                    try {
                      ...
                      toast.success('Wallet withdrawal request submitted');
                ...
                >
                  ...
                  <button
                    ...
                    className="btn-gold whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {walletPayoutSubmitting ? 'Submitting...' : 'Request Wallet Withdrawal'}
                  </button>
                </form>
                
                {/* Wallet Withdrawal History */}
                <div className="border-t border-[rgba(212,175,55,0.1)] pt-6">
                  <h4 className="text-lg font-semibold text-white mb-4">Wallet Withdrawal History</h4>
                  {(!walletPayoutHistory || walletPayoutHistory.length === 0) ? (
                    <p className="text-gray-400 text-sm">No wallet withdrawal requests yet.</p>
                  ) : (
                    <div className="overflow-x-auto">
                      <table className="min-w-full text-sm">
                        <thead>
