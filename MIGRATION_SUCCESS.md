...
curl -X GET "https://repo-duplicator-11.preview.emergentagent.com/api/admin/platform-wallet" \
...
curl -X GET "https://repo-duplicator-11.preview.emergentagent.com/api/seller/orders/pending-deposit" \
