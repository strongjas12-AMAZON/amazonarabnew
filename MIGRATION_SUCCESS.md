...
curl -X GET "https://codeduplicator-4.preview.emergentagent.com/api/admin/platform-wallet" \
...
curl -X GET "https://codeduplicator-4.preview.emergentagent.com/api/seller/orders/pending-deposit" \
