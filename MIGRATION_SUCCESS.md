...
curl -X GET "https://git-mirror-8.preview.emergentagent.com/api/admin/platform-wallet" \
...
curl -X GET "https://git-mirror-8.preview.emergentagent.com/api/seller/orders/pending-deposit" \
